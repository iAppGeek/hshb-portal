...
**New file:** `src/app/_components/OfflineBanner.tsx`
...
**New file:** `src/app/_components/OfflineBanner.spec.tsx`
...
**New file:** `src/app/_components/OfflineNotice.tsx`
...
**New file:** `src/app/_components/OfflineNotice.spec.tsx`
...
| --- | ------------------------------------------------------- | -------------------------------- | ------------------ |
| 1   | `src/app/attendance/AttendanceForm.tsx`                 | `isPending \|\| !allSelected`    | `+ \|\| !isOnline` |
| 2   | `src/app/staff-attendance/StaffAttendanceTable.tsx`     | `isPending` (×2: signIn/signOut) | `+ \|\| !isOnline` |
| 3   | `src/app/students/new/AddStudentForm.tsx`               | `isPending`                      | `+ \|\| !isOnline` |
| 4   | `src/app/students/[id]/edit/EditStudentForm.tsx`        | `isPending`                      | `+ \|\| !isOnline` |
| 5   | `src/app/staff/new/AddStaffForm.tsx`                    | `isPending`                      | `+ \|\| !isOnline` |
| 6   | `src/app/staff/[id]/edit/EditStaffForm.tsx`             | `isPending`                      | `+ \|\| !isOnline` |
| 7   | `src/app/classes/ClassForm.tsx`                         | `isPending`                      | `+ \|\| !isOnline` |
| 8   | `src/app/lesson-plans/new/AddLessonPlanForm.tsx`        | `isPending`                      | `+ \|\| !isOnline` |
| 9   | `src/app/lesson-plans/[id]/edit/EditLessonPlanForm.tsx` | `isPending`                      | `+ \|\| !isOnline` |
| 10  | `src/app/incidents/new/AddIncidentForm.tsx`             | `isPending`                      | `+ \|\| !isOnline` |
| 11  | `src/app/incidents/[id]/edit/EditIncidentForm.tsx`      | `isPending`                      | `+ \|\| !isOnline` |
| 12  | `src/app/guardians/[id]/edit/EditGuardianForm.tsx`      | `isPending`                      | `+ \|\| !isOnline` |
...
| --- | -------------------------------------------------------- | ------------------------------------------ |
| 1   | `src/app/attendance/AttendanceForm.spec.tsx`             | submit disabled when offline               |
| 2   | `src/app/staff-attendance/StaffAttendanceTable.spec.tsx` | sign-in and sign-out disabled when offline |
| 3   | `src/app/students/new/AddStudentForm.spec.tsx`           | submit disabled when offline               |
| 4   | `src/app/students/[id]/edit/EditStudentForm.spec.tsx`    | submit disabled when offline               |

**New test files needed** (these form components currently have no spec):

| #   | New spec file                                                | Tests                                      |
| --- | ------------------------------------------------------------ | ------------------------------------------ |
| 5   | `src/app/classes/ClassForm.spec.tsx`                         | renders form, submit disabled when offline |
| 6   | `src/app/staff/new/AddStaffForm.spec.tsx`                    | renders form, submit disabled when offline |
| 7   | `src/app/staff/[id]/edit/EditStaffForm.spec.tsx`             | renders form, submit disabled when offline |
| 8   | `src/app/lesson-plans/new/AddLessonPlanForm.spec.tsx`        | renders form, submit disabled when offline |
| 9   | `src/app/lesson-plans/[id]/edit/EditLessonPlanForm.spec.tsx` | renders form, submit disabled when offline |
| 10  | `src/app/incidents/new/AddIncidentForm.spec.tsx`             | renders form, submit disabled when offline |
| 11  | `src/app/incidents/[id]/edit/EditIncidentForm.spec.tsx`      | renders form, submit disabled when offline |
| 12  | `src/app/guardians/[id]/edit/EditGuardianForm.spec.tsx`      | renders form, submit disabled when offline |
...
**File:** `src/app/_components/PortalSidebar.tsx`
...
**New file:** `src/app/_components/PortalSidebar.spec.tsx`
...
| #   | File                                         | Link text                      |
| --- | -------------------------------------------- | ------------------------------ |
| 1   | `src/app/students/page.tsx`                  | "Add student"                  |
| 2   | `src/app/staff/page.tsx`                     | "Add Staff"                    |
| 3   | `src/app/classes/page.tsx`                   | "Add Class"                    |
| 4   | `src/app/incidents/IncidentsClient.tsx`      | "Add incident"                 |
| 5   | `src/app/lesson-plans/LessonPlansClient.tsx` | "New lesson plan" (or similar) |
...
| #   | Spec file                                         | Test to add                                  |
| --- | ------------------------------------------------- | -------------------------------------------- |
| 1   | `src/app/students/page.spec.tsx`                  | "Add student" link disabled when offline     |
| 2   | `src/app/staff/page.spec.tsx`                     | "Add Staff" link disabled when offline       |
| 3   | `src/app/classes/page.spec.tsx`                   | "Add Class" link disabled when offline       |
| 4   | `src/app/incidents/IncidentsClient.spec.tsx`      | "Add incident" link disabled when offline    |
| 5   | `src/app/lesson-plans/LessonPlansClient.spec.tsx` | "New lesson plan" link disabled when offline |
...
| `src/app/_components/OfflineBanner.tsx`                      | Amber banner in layout when offline                  |
| `src/app/_components/OfflineBanner.spec.tsx`                 | Tests for banner                                     |
| `src/app/_components/OfflineNotice.tsx`                      | Inline "saving unavailable" message for forms        |
| `src/app/_components/OfflineNotice.spec.tsx`                 | Tests for notice                                     |
...
| `src/app/_components/PortalSidebar.spec.tsx`                 | Tests for sidebar (new — none existed)               |
| `src/app/classes/ClassForm.spec.tsx`                         | Tests for class form (new — none existed)            |
| `src/app/staff/new/AddStaffForm.spec.tsx`                    | Tests for add staff form (new — none existed)        |
| `src/app/staff/[id]/edit/EditStaffForm.spec.tsx`             | Tests for edit staff form (new — none existed)       |
| `src/app/lesson-plans/new/AddLessonPlanForm.spec.tsx`        | Tests for add lesson plan form (new — none existed)  |
| `src/app/lesson-plans/[id]/edit/EditLessonPlanForm.spec.tsx` | Tests for edit lesson plan form (new — none existed) |
| `src/app/incidents/new/AddIncidentForm.spec.tsx`             | Tests for add incident form (new — none existed)     |
| `src/app/incidents/[id]/edit/EditIncidentForm.spec.tsx`      | Tests for edit incident form (new — none existed)    |
| `src/app/guardians/[id]/edit/EditGuardianForm.spec.tsx`      | Tests for edit guardian form (new — none existed)    |
...
| File                                                    | Change                                 |
| ------------------------------------------------------- | -------------------------------------- |
| `public/sw.js`                                          | Add RSC + JS chunk caching, bump to v4 |
| `src/app/layout.tsx`                                    | Add `<OfflineBanner />`                |
| `src/app/_components/PortalSidebar.tsx`                 | Disable sign-out + refresh offline     |
| `src/app/attendance/AttendanceForm.tsx`                 | Disable submit offline                 |
| `src/app/staff-attendance/StaffAttendanceTable.tsx`     | Disable sign-in/out offline            |
| `src/app/students/new/AddStudentForm.tsx`               | Disable submit offline                 |
| `src/app/students/[id]/edit/EditStudentForm.tsx`        | Disable submit offline                 |
| `src/app/staff/new/AddStaffForm.tsx`                    | Disable submit offline                 |
| `src/app/staff/[id]/edit/EditStaffForm.tsx`             | Disable submit offline                 |
| `src/app/classes/ClassForm.tsx`                         | Disable submit offline                 |
| `src/app/lesson-plans/new/AddLessonPlanForm.tsx`        | Disable submit offline                 |
| `src/app/lesson-plans/[id]/edit/EditLessonPlanForm.tsx` | Disable submit offline                 |
| `src/app/incidents/new/AddIncidentForm.tsx`             | Disable submit offline                 |
| `src/app/incidents/[id]/edit/EditIncidentForm.tsx`      | Disable submit offline                 |
| `src/app/guardians/[id]/edit/EditGuardianForm.tsx`      | Disable submit offline                 |
| `src/app/students/page.tsx`                             | `OfflineGuardedLink` for Add button    |
| `src/app/staff/page.tsx`                                | `OfflineGuardedLink` for Add button    |
| `src/app/classes/page.tsx`                              | `OfflineGuardedLink` for Add button    |
| `src/app/incidents/IncidentsClient.tsx`                 | `OfflineGuardedLink` for Add button    |
| `src/app/lesson-plans/LessonPlansClient.tsx`            | `OfflineGuardedLink` for Add button    |

**Existing test files to update** (add offline-specific assertions):

| File                                                     | New test                                |
| -------------------------------------------------------- | --------------------------------------- |
| `src/app/attendance/AttendanceForm.spec.tsx`             | submit disabled when offline            |
| `src/app/staff-attendance/StaffAttendanceTable.spec.tsx` | sign-in/out disabled when offline       |
| `src/app/students/new/AddStudentForm.spec.tsx`           | submit disabled when offline            |
| `src/app/students/[id]/edit/EditStudentForm.spec.tsx`    | submit disabled when offline            |
| `src/app/students/page.spec.tsx`                         | "Add student" disabled when offline     |
| `src/app/staff/page.spec.tsx`                            | "Add Staff" disabled when offline       |
| `src/app/classes/page.spec.tsx`                          | "Add Class" disabled when offline       |
| `src/app/incidents/IncidentsClient.spec.tsx`             | "Add incident" disabled when offline    |
| `src/app/lesson-plans/LessonPlansClient.spec.tsx`        | "New lesson plan" disabled when offline |

...
- `src/app/students/new/AddStudentForm.tsx` — add "Receives emails" checkbox next to secondary guardian and each additional contact section
- `src/app/students/new/actions.ts` — pass the 3 new fields through to `createStudent()`

### 2d. Update student edit form & action

**Files:**

- `src/app/students/[id]/edit/EditStudentForm.tsx` — same checkboxes, defaulting to current values
- `src/app/students/[id]/edit/actions.ts` — pass the 3 new fields through to `updateStudent()`
...
**File:** `src/app/admin/_components/AdminTabBar.tsx`
...
**New file:** `src/app/admin/_tabs/bulk-email/BulkEmailTab.tsx`
...
- `src/app/admin/page.spec.tsx` — update for new tab, broadened permissions
- `src/app/admin/_components/AdminTabBar.spec.tsx` — test tab visibility per role
...
| `src/app/admin/_tabs/bulk-email/BulkEmailTab.tsx` + `.spec.tsx` | Server tab wrapper            |
...
| `src/app/admin/page.tsx`                         | Add bulk-email tab rendering, broadened permission                        |
| `src/app/admin/_components/AdminTabBar.tsx`      | Role-based tab visibility                                                 |
| `src/app/students/new/AddStudentForm.tsx`        | Receives emails checkboxes                                                |
| `src/app/students/new/actions.ts`                | Pass new fields                                                           |
| `src/app/students/[id]/edit/EditStudentForm.tsx` | Receives emails checkboxes                                                |
| `src/app/students/[id]/edit/actions.ts`          | Pass new fields                                                           |

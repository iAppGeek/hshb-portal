...
describe('StudentDetailsModal', () => {
  ...
  it('shows guardian Edit link for admin with correct href', () => {
    ...
    expect(editLink.getAttribute('href')).toBe('/guardians/guardian-1/edit')
  })
  ...
  it('shows Edit links for each guardian when multiple are present', () => {
    ...
    expect(hrefs).toContain('/guardians/guardian-1/edit')
    expect(hrefs).toContain('/guardians/guardian-2/edit')
  })
